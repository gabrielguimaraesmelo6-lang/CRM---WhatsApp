...
export const AUTOMATION_TEMPLATES: Record<TemplateSlug, AutomationTemplateDefinition> = {
  ...
  out_of_office: {
    ...
    description: 'Responde automaticamente fora do horário de atendimento para que ninguém fique esperando.',
    ...
    steps: [
      ...
      },
      {
        ...
        step_config: {
          text:
            "Obrigado pela sua mensagem! Nossa equipe está offline no momento (9h–18h) e retornará assim que possível amanhã.",
        },
        parent_index: 0,
        branch: 'yes',
      },
    ...
    steps: [
      {
        ...
        step_config: {
          text:
            "Ótimo — vamos te ajudar com o preço! Uma pergunta rápida: para quantos usuários você está buscando?",
        },
      },
      {
        step_type: 'wait',
  ...
  follow_up_reminder: {
    ...
    steps: [
      ...
      },
      {
        ...
        step_config: {
          text:
            "Só retomando o contato — ainda tem alguma dúvida? Estamos à disposição para ajudar!",
        },
      },
    ],
  },
